...
오류가 났을 때 **환자에게 심각한 위해**가 가는 약입니다. ISMP가 목록을 관리합니다.
...
{{< callout type="info" >}}
2026 출제 범위에서 **조제(compounding) 지식 영역 자체는 제외**되었지만, 위험 약물 취급과 환자 안전 원칙은 여전히 이 도메인에 남아 있습니다.
{{< /callout >}}
